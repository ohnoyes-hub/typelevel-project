...
var _appFastoptJs = require("./target/scala-3.3.4/app-fastopt.js");
(0, _appFastoptJs.OhNoYesApp)().doSomething("app");

},{"./target/scala-3.3.4/app-fastopt.js":"6IncV"}],"6IncV":[function(require,module,exports,__globalThis) {
'use strict';
...
/** @constructor */ function $c_Lcom_ohnoyes_jobsboard_App() {
/*<skip>*/ }
$c_Lcom_ohnoyes_jobsboard_App.prototype = new $h_O();
$c_Lcom_ohnoyes_jobsboard_App.prototype.constructor = $c_Lcom_ohnoyes_jobsboard_App;
/** @constructor */ function $h_Lcom_ohnoyes_jobsboard_App() {
/*<skip>*/ }
$h_Lcom_ohnoyes_jobsboard_App.prototype = $c_Lcom_ohnoyes_jobsboard_App.prototype;
$c_Lcom_ohnoyes_jobsboard_App.prototype.doSomething__T__V = function(container) {
    document.getElementById(container).innerHTML = "Hello, from Scala.js!";
};
$c_Lcom_ohnoyes_jobsboard_App.prototype.$js$exported$meth$doSomething__T__O = function(container) {
    this.doSomething__T__V(container);
};
$c_Lcom_ohnoyes_jobsboard_App.prototype.doSomething = function(arg) {
    var prep0 = $as_T(arg);
    return this.$js$exported$meth$doSomething__T__O(prep0);
};
var $d_Lcom_ohnoyes_jobsboard_App = new $TypeData().initClass({
    Lcom_ohnoyes_jobsboard_App: 0
}, false, "com.ohnoyes.jobsboard.App", {
    Lcom_ohnoyes_jobsboard_App: 1,
    O: 1
});
$c_Lcom_ohnoyes_jobsboard_App.prototype.$classData = $d_Lcom_ohnoyes_jobsboard_App;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
exports.OhNoYesApp = function() {
    return new $c_Lcom_ohnoyes_jobsboard_App();
};
